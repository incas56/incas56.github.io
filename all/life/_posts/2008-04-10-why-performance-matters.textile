...
<p>我们</a>.   The highlight for me:</p>

<blockquote>
"A lot of people seem to think that performance is about doing the same thing just doing it faster and that's not true.  That's not what performance is all about.  If you can do something really really fast, really well, people start using it different."</blockquote>
...
<p>*Git is a source control management system which is used by the Linux kernel team and is quickly gaining a lot of popularity. </p>
